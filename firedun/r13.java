...
public class r13 extends room {  
    ...
    public r13( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom, firedungeon w )
    {
        ...
        ladder2 = new ladderdown( 200, 500, constants.firedunfloor, this.weap3, this, constants.firedunladder );
        ...
        unit bag1 = new flamethrower(this, 500, 500 - 1, ai1);
        this.addbag(bag1);
