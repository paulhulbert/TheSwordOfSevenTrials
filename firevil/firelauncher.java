 ...
 * @author Dad
 */
public class firelauncher extends unit {
    
    public firelauncher( ArrayList<weapon> weaps, room currentroom, int x, int y )
    {
        super( 100, 1, 1, "fireballdown", x, y, new noai(), weaps, currentroom, 100, 140 );
