 ...
 * @author Dad
 */
public class spearlauncher extends unit {
    
    
    public spearlauncher( room currentroom, int x, int y, AI ai )
    {
        super( 60, 0, 4, "electricspear", x, y, ai, currentroom.getweap2(), currentroom, 100, 140 );
