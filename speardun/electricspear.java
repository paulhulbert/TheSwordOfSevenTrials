 ...
 * @author Dad
 */
public class electricspear extends weapon {
    ...
    public electricspear( int x, int y, int dir, int momentx, int momenty )
    {
            
        super( x - dir * 10, y + 10, dir * 15, 1, 10, 150, false, new boolean[10], new Color[10], 33, 5, momentx, momenty );
