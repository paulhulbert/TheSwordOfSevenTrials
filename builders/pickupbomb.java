 ...
 * @author Dad
 */
public class pickupbomb extends unit {
    
    
    
    public pickupbomb( room currentroom, int x, int y )
    {
        ...
        trigger spoke1 = new trigger( false, "gotweap2_bomb" );
        
        chattrigger chat1 = new chattrigger( constants.truetrigger, spoke1, true );
        
        chat1.addchat( "You got bombs!  Careful, these explosive weapons can hurt you too." );
