 ...
 * @author Dad
 */
public class greenspikeelder extends unit {
    
    public greenspikeelder( room currentroom, int x, int y, AI ai )
    {
        super( 90, 0, 4, "greenspikeball", x, y, ai, currentroom.getweap2(), currentroom, 100, 140 );
