...
public class bombroom extends room {  
    ...
    public bombroom( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom )
    {
        ...
        bombs = new builders.pickupbomb(this, 600, 500);
        this.addneutral(bombs);
    ...
    {
        if ( !gotit && getpanel().getsavefile().gettrigger("gotweap2_bomb").gettrigger() ) {
            neutral.remove(bombs);
        }
