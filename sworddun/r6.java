...
public class r6 extends room2 {  
    ...
    public r6( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom, sworddungeon w )
    {
        ...
        ladder1 = new ladderdown( 200, 500, constants.sworddunfloor, this.weap3, this, "LIGHT_GRAY" );
