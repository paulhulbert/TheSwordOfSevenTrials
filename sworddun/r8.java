...
public class r8 extends room2 {  
    ...
    public r8( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom, sworddungeon w )
    {
        ...
        platform lock1 = new lockwall(1100, 500, 200, base, Color.BLUE, weap3, w.r8_lock, panel);
        
        this.addplatform(lock1);
        
        AI ai1 = new basicai();
        ai1.settarget(mainchar);
        unit bag1 = new builders.gobwarrior(this, 1200, 500 - 1, ai1);
        this.addbag(bag1);
