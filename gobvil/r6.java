...
public class r6 extends room {  
    ...
    public r6( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom, world w )
    {
        ...
        ladder2 = new ladderdown( 200, 500, Color.darkGray, this.weap3, this, "LIGHT_GRAY" );
        ...
        unit bag1 = new builders.gobwarrior(this, 300, 500 - 1, ai1);
        this.addbag(bag1);
    }
