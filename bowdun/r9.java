...
public class r9 extends room {  
    ...
    public r9( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom, bowdungeon w )
    {
        ...
        ladder2 = new ladderdown( 200, 500, constants.bowdunfloor, this.weap3, this, constants.bowdunladder );
