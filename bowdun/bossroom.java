...
public class bossroom extends room2 {  
    ...
    public bossroom( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom, bowdungeon w )
    {
        ...
        ceiling2 = new every.hardblock(-5, -5, 1105, 25, base, base, false, weap3);
        addplatform(ceiling2);
        
        platform ceiling1 = new every.hardblock(1100, -5, 1000, 25, base, base, false, weap3);
        addplatform(ceiling1);
        
        platform lock1 = new lockwall(1000, 500, 400, base, Color.YELLOW, weap3, locked, panel);
        ...
        boss = new bossunit(this, 200, -20, new bossai(locked));
    ...
    public void resetroom()
    {
        ...
        if ( getpanel().getsavefile().gettrigger("gotweap_bow").gettrigger() ) {
    ...
    public void step( Graphics g )
    {
        ...
        if ( killed.gettrigger() && !added && !getpanel().getsavefile().gettrigger("gotweap_bow").gettrigger() ) {
            locked.settrigger(false);
            addneutral( sword );
            added = true;
            terrain.remove(buttona);
        ...
        if ( getpanel().getsavefile().gettrigger("gotweap_bow").gettrigger() && added ) {
