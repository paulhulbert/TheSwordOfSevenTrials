...
public class r13 extends room {  
    ...
    public r13( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom, bowdungeon w )
    {
        ...
        ladder1 = new ladderup( 100, 500, constants.bowdunfloor, this.weap3, this, constants.bowdunladder );
        
        ladder2 = new ladderdown( 1000, 500, constants.bowdunfloor, this.weap3, this, constants.bowdunladder );
        
        ladder1.setWarpx(900);
        
        ladder2.setWarpx(200);
