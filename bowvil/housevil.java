 ...
 * @author Dad
 */
public class housevil extends unit {
    
    public housevil( ArrayList<weapon> weaps, room currentroom, int x, int y )
    {
        ...
        this.setStatement("Welcome to Bowvil");
...
Color se = new Color(58,34,0);
Color sf = new Color(124,255,109);
