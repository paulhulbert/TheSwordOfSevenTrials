 ...
 * @author Dad
 */
public class warp_blankvil extends fieldroom {  
    
    private platform state1;
    
    public warp_blankvil( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom )
    {
        ...
        unit sign1 = new sign( 400, 441, this.getweap3(), this, "Magedoor to Penvil." );
