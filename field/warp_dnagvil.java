 ...
 * @author Dad
 */
public class warp_dnagvil extends fieldroom {  
    
    platform state1;
    
    public warp_dnagvil( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom )
    {
        ...
        unit sign1 = new sign( 400, 441, this.getweap3(), this, "Magedoor to Dnagvil." );
