 ...
 * @author Dad
 */
public class warp_firevil extends fieldroom {  
    
    platform state1;
    
    public warp_firevil( jpanel1 panel, Color background, Color base, ArrayList<platform> platforms, ArrayList<unit> bags, unit maincharacter, room leftroom, room rightroom, room middleroom )
    {
        ...
        unit sign1 = new sign( 400, 441, this.getweap3(), this, "Magedoor to firevil." );
        
        this.addneutral(sign1);
        
        
        unit goblin = new firedun.flamethrower( this, 300, 500 - 74, new noai());
