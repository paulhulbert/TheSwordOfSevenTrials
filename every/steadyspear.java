 ...
 * @author Dad
 */
public class steadyspear extends weapon {
    ...
    public steadyspear( int x, int y, int dir )
    {
            
        super( x - dir * 10, y + 30, dir, 0, 10, 30, true, new boolean[10], new Color[10], 96, 8, 0, 0 );
