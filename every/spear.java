...
public class spear extends weapon {
    ...
    public spear( int x, int y, int dir, int momentx, int momenty, unit u )
    {
            
        super( x - dir * 10, y + 30, dir * 5, 0, 10, 80, true, new boolean[10], new Color[10], 96, 8, momentx, momenty, u );
