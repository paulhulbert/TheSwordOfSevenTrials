 ...
 * @author Dad
 */
public class gobclaws_bag extends weapon {
    ...
    public gobclaws_bag( int x, int y, int dir, int momentx, int momenty, unit u )
    {
            
        super( x + dir * 10, y + 20, dir * 5, 5, 2, 30, true, new boolean[10], new Color[10], 35, 11, momentx, momenty, u );
